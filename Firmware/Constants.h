...
static const uint8_t defaultSettings[][4] PROGMEM = {
  ...
  {  35,  50,  25, HIGH_DELAY}, // Нічне Місто        |  {"n":"Нічне Місто","v":[1,255,50,50,0]}, Night City
  {  35,  90,  50, HIGH_DELAY}, // Аврора             |  {"n":"Аврора","v":[1,255,50,50,0]}, Avrora
  {  40, 200,  40,    DYNAMIC}, // Веселкова Пляма    |  {"n":"Веселкова Пляма","v":[1,255,1,100,0]}, Rainbow Spot
